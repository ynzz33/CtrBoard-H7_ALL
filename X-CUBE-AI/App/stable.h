...
#define AI_STABLE_ORIGIN_MODEL_NAME   "stable_pos0_23_0_65_p15_0_d1_0_0_1"

/******************************************************************************/
#define AI_STABLE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_STABLE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STABLE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STABLE_IN_NUM        (2)

AI_DEPRECATED
#define AI_STABLE_IN \
  ai_stable_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STABLE_IN_SIZE { \
  AI_STABLE_IN_1_SIZE, \
  AI_STABLE_IN_2_SIZE, \
}
#define AI_STABLE_IN_SIZE_BYTES { \
  AI_STABLE_IN_1_SIZE_BYTES, \
  AI_STABLE_IN_2_SIZE_BYTES, \
}
#define AI_STABLE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STABLE_IN_1_CHANNEL     (25)
#define AI_STABLE_IN_1_SIZE        (25)
#define AI_STABLE_IN_1_SIZE_BYTES  (100)
#define AI_STABLE_IN_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STABLE_IN_2_CHANNEL     (125)
#define AI_STABLE_IN_2_SIZE        (125)
#define AI_STABLE_IN_2_SIZE_BYTES  (500)

/******************************************************************************/
#define AI_STABLE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STABLE_OUT \
  ai_stable_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STABLE_OUT_SIZE { \
  AI_STABLE_OUT_1_SIZE, \
}
#define AI_STABLE_OUT_SIZE_BYTES { \
  AI_STABLE_OUT_1_SIZE_BYTES, \
}
#define AI_STABLE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STABLE_OUT_1_CHANNEL     (6)
#define AI_STABLE_OUT_1_SIZE        (6)
#define AI_STABLE_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_STABLE_N_NODES (13)
 ...
 * @ref ai_stable_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stable_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stable_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STABLE_*
 * defines into file @ref stable.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
