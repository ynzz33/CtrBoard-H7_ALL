...
#define AI_JUMP_INPUTS_IN_ACTIVATIONS   (4)
#define AI_JUMP_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_JUMP_IN_NUM        (2)

AI_DEPRECATED
#define AI_JUMP_IN \
  ai_jump_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_JUMP_IN_SIZE { \
  AI_JUMP_IN_1_SIZE, \
  AI_JUMP_IN_2_SIZE, \
}
#define AI_JUMP_IN_SIZE_BYTES { \
  AI_JUMP_IN_1_SIZE_BYTES, \
  AI_JUMP_IN_2_SIZE_BYTES, \
}
#define AI_JUMP_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_JUMP_IN_1_CHANNEL     (25)
#define AI_JUMP_IN_1_SIZE        (25)
#define AI_JUMP_IN_1_SIZE_BYTES  (100)
#define AI_JUMP_IN_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_JUMP_IN_2_CHANNEL     (125)
#define AI_JUMP_IN_2_SIZE        (125)
#define AI_JUMP_IN_2_SIZE_BYTES  (500)

/******************************************************************************/
#define AI_JUMP_OUT_NUM       (1)

AI_DEPRECATED
#define AI_JUMP_OUT \
  ai_jump_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_JUMP_OUT_SIZE { \
  AI_JUMP_OUT_1_SIZE, \
}
#define AI_JUMP_OUT_SIZE_BYTES { \
  AI_JUMP_OUT_1_SIZE_BYTES, \
}
#define AI_JUMP_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_JUMP_OUT_1_CHANNEL     (6)
#define AI_JUMP_OUT_1_SIZE        (6)
#define AI_JUMP_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_JUMP_N_NODES (13)
 ...
 * @ref ai_jump_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_JUMP_*
 * defines into file @ref jump.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
